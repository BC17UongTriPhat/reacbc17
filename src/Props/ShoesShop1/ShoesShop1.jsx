...
export default class ShoesShop1 extends Component {

     // thuộc tính nên bên dưới phải có con trỏ this
     dataProduct = [ 
        {
            "id": 1,
    ...
    return (
      <div className='container-fluid'>
            <div className='row'>
                ...
                <div className='col-8'>
                    {/* là thuộc tính nên phải có con trỏ this */}
                    <ProductList1 dataProduct={this.dataProduct}/>
                </div>
            </div>
      </div>
    )
